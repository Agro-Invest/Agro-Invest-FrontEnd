...
const InvestorsCard = ({theme, numberOfIvestors, percentage}) => {
  return (
    <div className="h-28 w-72 border bg-white border-1 border-gray-400 rounded-2xl py-0 px-3">
      <div className="flex flex-row justify-between relative">
        ...
        <div className="h-14 w-14 border border-gray-400 
          ...
          <img src={People} alt="" className="size-7"/>
        </div>
