...
const FarmProjects = ({ theme, numberOfProjects, percentage}) => {
  return (
    <div className="h-28 w-72 border bg-white border-gray-400 rounded-2xl py-0 px-3">
      <div className="flex flex-row justify-between relative">
        ...
        <div className="h-14 w-14 border border-gray-400 
            rounded-full absolute top-7 right-0 flex items-center justify-center py-1 px-1">
          <img src={Crop} alt="" className="size-7"/>
        </div>
